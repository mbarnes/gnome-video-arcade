...
/**
 * gva_db_verify_romsets:
 * @error: return location for a #GError, or %NULL
 *
 * Starts the lengthy process of verifying the integrity of the available
 * ROM sets and returns a #GvaProcess to track it.  The results of the
 * verification process are written to the "romset" column of the game
 * database.  If an error occurs while starting the verification process,
...
/**
 * gva_db_verify_samplesets:
 * @error: return location for a #GError, or %NULL
 *
 * Starts the lengthy process of verifying the integrity of the available
 * sample sets and returns a #GvaProcess to track it.  The results of the
 * verification process are written to the "sampleset" column of the game
 * database.  If an error occurs while starting the verification process,
 * it returns %NULL and sets @error.
 *
 * Returns: a new #GvaProcess, or %NULL
